...
/* ======================================= */
/* 🌟 โค้ดกล่องและปุ่มกลับหน้าแรกที่เพิ่มเข้าไปใหม่ 🌟 */
/* ======================================= */
.back-container {
  background: rgba(255, 255, 255, 0.03); /* กล่องกระจกฝ้าบางๆ */
  backdrop-filter: blur(10px);
...
.btn-back {
  ...
  padding: 12px 28px;
  background-color: #eab308; /* สีปุ่มสีเหลืองทอง */
  color: #ffffff;            /* 🎨 เปลี่ยนสีคำเป็นสีขาวสว่างตามที่ขอแล้วครับ! */
  text-decoration: none;
  border-radius: 50px;
  font-weight: bold;
  font-size: 16px;
...
.btn-back:hover {
  background-color: #fef08a; /* ตอนเมาส์ชี้ปุ่มจะสว่างขึ้น */
  color: #1e293b;            /* ตอนเมาส์ชี้ข้อความจะเปลี่ยนเป็นสีมืดเพื่อให้อ่านง่าย */
...
<header>
    <img src="Frank.jpg" alt="รูปเจ้าของผลงาน">
    <h1>แฟ้มสะสมผลงาน</h1>
...
<div class="back-container">
  <a href="index.html" class="btn-back">🏠 กลับหน้าแรก 😎 ❤️ 👌</a>
</div>
